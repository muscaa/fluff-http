...
/**
 * Enumeration of HTTP response status codes and their respective messages.
 */
public enum HTTPResponseStatus {
    ...
    private HTTPResponseStatus(int code, Series series, String message) {
        this.code = code;
        this.series = series;
    ...
    /**
     * Returns the status code of the HTTP response status.
     *
    ...
    /**
     * Returns the series of the HTTP response status.
     *
     * @return the series
     */
    ...
    /**
     * Returns the message of the HTTP response status.
     *
     * @return the message
     */
    ...
    /**
     * Returns the HTTPResponseStatus corresponding to the given status code.
     *
     * @param code the status code
     * @return the corresponding HTTPResponseStatus, or null if not found
     */
    ...
    /**
     * Enumeration of HTTP response status series.
     */
    public static enum Series {
        ...
        /**
         * Returns the integer value of the series.
         *
        ...
        /**
         * Returns the Series corresponding to the given status code.
         *
        ...
        /**
         * Resolves the Series corresponding to the given status code.
         *
         * @param statusCode the status code
